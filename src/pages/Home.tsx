    ...
    <div className="pt-20">
      <section ref={heroRef} className="bg-gray-100 py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <button className="px-8 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-800 hover:scale-110 hover:shadow-2xl transition-all duration-500 font-medium scroll-entrance initial-visible bounce-in scroll-stagger-4 smooth-exit">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mx-auto mb-16">
            <div className="bg-gray-100 rounded-2xl p-8 text-center mb-12 scroll-entrance scale-up scroll-stagger-1 hover:bg-gray-200 hover:scale-105 hover:shadow-xl transition-all duration-500 cursor-default smooth-exit">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-gray-100 rounded-2xl aspect-[4/3] flex items-center justify-center scroll-entrance slide-left scroll-stagger-3 hover:bg-gray-200 hover:scale-105 hover:shadow-xl transition-all duration-500 cursor-default group smooth-exit">
            ...
            <div className="bg-gray-100 rounded-2xl aspect-[4/3] flex items-center justify-center scroll-entrance slide-right scroll-stagger-4 hover:bg-gray-200 hover:scale-105 hover:shadow-xl transition-all duration-500 cursor-default group smooth-exit">
              <p className="text-gray-500 group-hover:text-gray-700 transition-colors duration-500">Imagen referencial del resultado del proyecto</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-8">
            {services.map((service, index) => (
              <div
                key={index}
                className={`bg-gray-50 rounded-2xl p-8 md:p-12 grid md:grid-cols-2 gap-8 items-center scroll-entrance scale-up scroll-stagger-${index + 2} hover:bg-gray-100 hover:scale-105 hover:shadow-2xl transition-all duration-500 cursor-default group smooth-exit`}
              >
                <div>
                  <div className="mb-4">
                    {index === 0 && (
                  ...
                  <button className="px-6 py-2 bg-gray-300 text-gray-900 rounded-lg hover:bg-gray-400 hover:scale-110 hover:shadow-lg transition-all duration-500 font-medium smooth-exit">
                    Descubre más
                  </button>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 mb-8">
            {projects.map((project, index) => (
              <div key={project.id} className={`group cursor-pointer scroll-entrance scale-up scroll-stagger-${index + 3} hover:scale-105 transition-all duration-500 smooth-exit`}>
          ...
          <div className="text-center">
            <button className="text-gray-900 font-medium hover:text-gray-600 hover:scale-110 hover:shadow-lg transition-all duration-500 scroll-entrance bounce-in scroll-stagger-6 px-6 py-3 rounded-lg hover:bg-gray-100 smooth-exit">
              Ver más ↓
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
            {team.map((member, index) => (
              <div key={index} className={`bg-gray-100 rounded-2xl p-12 text-center scroll-entrance scale-up scroll-stagger-${index + 3} hover:bg-gray-200 hover:scale-105 hover:shadow-2xl transition-all duration-500 cursor-default group smooth-exit`}>
