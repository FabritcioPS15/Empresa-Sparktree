        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-10">
            <div className="rounded-2xl bg-white border border-gray-200 p-4 reveal scale-up">
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Entregables</h2>
              <ul className="text-gray-600 space-y-2 text-sm">
                <li>Identidad visual y manual de marca</li>
                <li>Mensajes clave y voz de marca</li>
                <li>Aplicaciones y piezas principales</li>
                <li>Lanzamiento y guidelines</li>
              </ul>
            </div>
            <div className="rounded-2xl bg-gray-200 aspect-video flex items-center justify-center reveal rotate-in">
              <span className="text-gray-500">moodboard</span>
            </div>
          </div>

          <div className="flex gap-3">
            <button className="px-5 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors font-medium" onClick={() => onNavigate?.('portfolio')}>Ver marcas</button>
